...
<div id="gallery" class="container">
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-push-1 col-md-4 col-md-push-1">
                <h1>1</h1>
        ...
        <div class="row">
            <div class="col-lg-5 col-lg-push-1 text-right col-md-5 col-md-push-1">
                <h1>2</h1>
        ...
        <div id="third-image" class="row">
            <div class="col-lg-5 col-lg-push-1 col-md-5 col-md-push-1">
                <img src="img/gallery-image-3.png" width="563" height="311" alt="<?php echo _('Image of camper parked in middle of the nature') ?>" />
            </div>
            <div class="col-lg-4 col-lg-push-2 col-md-4 col-md-push-3">
                <h1>3</h1>
